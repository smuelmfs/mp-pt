...
function main() {
  console.log('📊 Analisando aba PASTAS PARA A4 do Excel\n');
  ...
  if (!sheet) {
    console.error('❌ Aba "PASTAS PARA A4" não encontrada');
    return;
  }
  ...
  const keywords = ['CLIENTE', 'FORMATO', 'GRAMAGEM', 'CUSTO', 'IMPRESSÃO', 'PLASTIFICAÇÃO', 'DOBRA'];
